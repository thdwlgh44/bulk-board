package com.portfolio.boardserver.aop;
...
public class LoginCheckAspect {
    ...
    @Around("@annotation(com.portfolio.boardserver.aop.LoginCheck && @ annotation(loginCheck)")
    public Object adminLoginCheck(ProceedingJoinPoint proceedingJoinPoint, LoginCheck loginCheck) throws Throwable {
        ...
        if (id == null) {
            ...
            throw new HttpStatusCodeException(HttpStatus.UNAUTHORIZED, "로그인 한 ID값을 확인해주세요.") {};
        }
