...
import com.portfolio.boardserver.exception.DuplicatedException;
...
import static com.portfolio.boardserver.utils.SHA256Util.encryptSHA256;
...
public class UserServiceImpl implements UserService {
    ...
    public void register(UserDTO userProfile) {
        ...
        userProfile.setCreateTime(new Date()); //현재시간 설정
